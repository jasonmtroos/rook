...
2. Read about R Markdown (mandatory) and git (optional) -- see previous slides for links
3. Follow the [R tutorials](http://www.jasonmtroos.com/assets/media/teaching/course_assignments_and_data.zip) I developed for my Marketing Analytics MSc course
    ...
    * Assignment 2, sections 1--2 -- linear and logistic regression
    * Assignment 3, section 2 -- ggplot2
    * Assignment 4 -- more ggplot2 and dplyr
