...
* If the package has been loaded successfully, you should be able to execute the following command without producing an error
...
4. Email me with questions: roos@rsm.nl
