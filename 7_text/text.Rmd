...
```{r}
d1 <- tibble(report = ufo_text) %>% mutate(id = row_number()) %>%
...
```{r}
anti_surp <- get_sentiments('nrc') %>% filter(sentiment %in% c('anticipation', 'surprise'))
d2 %>%
  inner_join(anti_surp, by = 'word') %>%
  group_by(id, sentence_id) %>%
  summarise(score = n()) %>% ungroup() %>%
  inner_join(d1) %>% top_n(5, score) %>%
  arrange(desc(score))
```
...
exemp_tab <- function(fit) {
  ...
  exemp <-
    tibble(name = get_topic_names(fit), top = ufo_text[exemplars])
...
* Three months of data, stemming and stopword removal

```{r echo=FALSE, results = 'asis', message = FALSE, warning = FALSE}
ufos <- bind_rows( 
  get_ufo_sightings('http://www.nuforc.org/webreports/ndxp190509.html'),
  get_ufo_sightings('http://www.nuforc.org/webreports/ndxp190425.html'),
  get_ufo_sightings('http://www.nuforc.org/webreports/ndxp190418.html'),
  get_ufo_sightings('http://www.nuforc.org/webreports/ndxp190412.html'),
  get_ufo_sightings('http://www.nuforc.org/webreports/ndxp190408.html'),
  get_ufo_sightings('http://www.nuforc.org/webreports/ndxp190329.html'),
  get_ufo_sightings('http://www.nuforc.org/webreports/ndxp190321.html'),
  get_ufo_sightings('http://www.nuforc.org/webreports/ndxp190315.html'),
  get_ufo_sightings('http://www.nuforc.org/webreports/ndxp190314.html'),
  get_ufo_sightings('http://www.nuforc.org/webreports/ndxp190227.html'),
  get_ufo_sightings('http://www.nuforc.org/webreports/ndxp190222.html'),
  get_ufo_sightings('http://www.nuforc.org/webreports/ndxp190214.html'),
  get_ufo_sightings('http://www.nuforc.org/webreports/ndxp190207.html')
  )
ufo_text <- ufos$Summary
