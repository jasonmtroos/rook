...
subtitle: "Session 1b: Getting your development environment in order"
author: "J.M.T. Roos"
...
Sticky notes (post-covid)
====================================

* Click on the participants buttom
* At the bottom of the participants list, there are buttons for "yes" and "no"
* Use the "yes" button if you're done and ready to move
* Use the "no" button if you're stuck and need help
...
if(program() == 'egsh') {
  ...
  asis_output('What you can do during the lunch break') 
}
```
=============================
...
<!-- 4. Email me with questions: [jroos@rsm.nl](mailto:jroos@rsm.nl) -->
